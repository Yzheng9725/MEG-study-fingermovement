...
%% plot Vertices number - ACTive-ROI Fig.6(a)
load('.\mat\Digit-map\AllTask_Acc_TASKnREST_Group.mat')  % Active-ROI-Accuracy on each vertex
...
load('.\mat\Digit-map\AllTask_Acc_4TASKs_Group.mat') % Digit-map-(4-class-classification)-Accuracy on each vertex
load('.\mat\Digit-map\DigitMap_Acc_4TASKs_Group.mat')  % Finger-label for each vertex
