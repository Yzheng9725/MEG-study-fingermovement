...
plot([0 0], [0 50], 'LineStyle','--', 'Color',[1 0 0 0.6],'LineWidth',0.8)
plot([0.1 0.1], [0 50], 'LineStyle','--', 'Color',[1 0 0 0.6],'LineWidth',0.8)
plot([0.25 0.25], [0 50], 'LineStyle','--', 'Color',[1 0 0 0.6],'LineWidth',0.8)
plot([0.60 0.60], [0 50], 'LineStyle','--', 'Color',[1 0 0 0.6],'LineWidth',0.8)
