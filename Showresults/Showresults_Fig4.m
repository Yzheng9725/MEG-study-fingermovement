...
nexttile
bar(x,mean(Acc2plot),0.6,'FaceColor',[242 119 115]/255,'EdgeColor','k','LineWidth',0.4)
hold on

errorbar(x,mean(Acc2plot),stderr,'k','LineStyle','-',...
    'MarkerSize',6,'LineWidth',1.0,'MarkerEdgeColor', 'none', 'MarkerFaceColor', 'k'); 
ylim([50 90])
xlim([0.4 16.6])
ylabel('ACC (%)') 
...
nexttile
bar(x,mean(Acc2plot_5cmb),0.6,'FaceColor',[242 119 115]/255,'EdgeColor','k','LineWidth',0.4)
hold on
